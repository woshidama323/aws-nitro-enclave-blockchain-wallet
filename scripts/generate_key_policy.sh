...
# instance id
asg_name=$(jq -r '.newDevNitroWalletEth.ASGGroupName' ${output})
...
# ec2 role
ec2_role_arn=$(jq -r '.newDevNitroWalletEth.EC2InstanceRoleARN' ${output})
# lambda role
lambda_execution_arn=$(jq -r '.newDevNitroWalletEth.LambdaExecutionRoleARN' ${output})
